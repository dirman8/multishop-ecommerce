const FilterColor = () => {
	const prices = [
		{ price: "All Color", items: 1000 },
		{ price: "Black", items: 150 },
		{ price: "White", items: 295 },
		{ price: "Red", items: 246 },
		{ price: "Blue", items: 145 },
		{ price: "Green", items: 168 },
	];
	return (
		<div className="mb-6">
			<div>
				<h1 className="relative mb-4 before:absolute before:w-full before:h-0 before:left-0 before:top-1/2 before:border-t before:border-dashGray before:border-dashed before:-z-10">
					<span className="text-xl font-semibold text-mediumGray bg-paleGray pr-4">FILTER BY COLOR</span>
				</h1>
			</div>
